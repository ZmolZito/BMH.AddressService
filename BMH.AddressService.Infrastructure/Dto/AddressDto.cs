...
namespace BMH.AddressService.Infrastructure.Dto
{
    ...
    public class Adgangsadresse
    {
        ...
        public Afstemningsområde afstemningsomrde { get; set; }
    ...
    public class Historik
    {
        ...
        public DateTime ndret { get; set; }
        public DateTime ikrafttrdelse { get; set; }
